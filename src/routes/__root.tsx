...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Painel PJ — pagamentos, 13ª nota e férias" },
      { name: "description", content: "Organize seu contrato PJ: salário, ajuda de custo, 13ª nota e férias remuneradas." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Painel PJ — pagamentos, 13ª nota e férias" },
      { property: "og:description", content: "Organize seu contrato PJ e o calendário de notas do ano." },
